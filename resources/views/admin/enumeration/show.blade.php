    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('projects.enumeration.edit', $enumeration) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    Edit
                </a>
                <form method="POST" action="{{ route('projects.enumeration.toggleVerification', $enumeration) }}" class="inline">
                    @csrf
                    @method('PATCH')
                ...
                <form method="POST" action="{{ route('projects.enumeration.destroy', $enumeration) }}" class="inline" onsubmit="return confirm('Are you sure you want to delete this enumeration?')">
                    @csrf
                    @method('DELETE')
