    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('customers.staff.edit', $staff) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    Edit Staff
                </a>
                <a href="{{ route('customers.staff.index', $staff->customer) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                    Back to Staff List
                </a>
            </div>
        </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <div class="mt-6 flex space-x-3">
                        <form method="POST" action="{{ route('customers.staff.toggleStatus', [$project, $staff]) }}" class="inline">
                            @csrf
                            @method('PATCH')
                        ...
                        @if($staff->enumerations->count() === 0)
                            <form method="POST" action="{{ route('customers.staff.destroy', [$project, $staff]) }}" class="inline" onsubmit="return confirm('Are you sure you want to delete this staff member?')">
                                @csrf
                                @method('DELETE')
