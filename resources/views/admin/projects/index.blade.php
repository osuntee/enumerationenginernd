    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('projects.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm sm:w-auto text-center">
                    Create New Project
                </a>
            </div>
        </div>
                ...
                <div class="p-6 text-gray-900">
                                ...
                                <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex space-x-2">
                                            <a href="{{ route('projects.show', $project) }}" class="flex-1 text-center bg-blue-500 hover:bg-blue-700 text-white py-2 px-3 rounded text-sm font-medium">
                                                View Project
                                            </a>
                                            <a href="{{ route('projects.staff.index', $project) }}" class="flex-1 text-center bg-indigo-500 hover:bg-indigo-700 text-white py-2 px-3 rounded text-sm font-medium">
                                                Manage Staff
                                            </a>
                                        </div>
                                        ...
                                        <div class="flex space-x-2">
                                            <a href="{{ route('projects.edit', $project) }}" class="flex-1 text-center bg-gray-500 hover:bg-gray-700 text-white py-2 px-3 rounded text-sm">
                                                Edit
                                            </a>
                                            @if($project->is_active)
                                                <form method="POST" action="{{ route('projects.deactivate', $project) }}" class="flex-1">
                                                    @csrf
                                                    @method('PATCH')
                                            ...
                                            @else
                                                <form method="POST" action="{{ route('projects.activate', $project) }}" class="flex-1">
                                                    @csrf
                                                    @method('PATCH')
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <a href="{{ route('projects.create') }}" class="inline-flex items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
