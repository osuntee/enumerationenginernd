                ...
                <div class="p-6">
                    <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="flex items-end space-x-2">
                            ...
                            <a href="{{ route('projects.payments.enumerations.index', $payment) }}" 
                ...
                <div class="p-6">
                                    ...
                                    @foreach($enumerationPayments as $enumerationPayment)
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                                <a href="{{ route('projects.payments.enumerations.show', $enumerationPayment) }}" 
                    ...
                    @else
                        ...
                        <div class="text-center py-12">
                            ...
                            @if(request()->hasAny(['search', 'status', 'amount_min']))
                                <div class="mt-6">
                                    <a href="{{ route('projects.payments.enumerations.transactions', $payment) }}" 
