<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('projects.payments.show', [$project, $payment]) }}" class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
                    View Payment
                </a>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('projects.payments.update', [$project, $payment]) }}">
                @csrf
                @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex justify-between pt-6 border-t border-gray-200">
                                <div class="flex space-x-2">
                                    ...
                                    <a href="{{ route('projects.payments.show', [$project, $payment]) }}" 
