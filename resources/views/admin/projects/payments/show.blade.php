    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('projects.payments.edit', [$payment->project, $payment]) }}" 
                   class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    Edit Payment
                </a>
                <a href="{{ route('projects.payments.index', $payment->project) }}" 
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <a href="{{ route('projects.payments.enumerations.index', $payment) }}" class="text-blue-600 hover:text-blue-900 text-sm">View All</a>
                        </div>
                                    ...
                                    @foreach($payment->enumerationPayments->take(10) as $enumerationPayment)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('projects.payments.enumerations.show', $enumerationPayment) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
