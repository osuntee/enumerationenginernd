    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('projects.payments.create', $project) }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Create Payment
                </a>
                                    ...
                                    @foreach($payments as $payment)
                                        <tr class="{{ $payment->is_active ? '' : 'bg-gray-50' }}">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                                <a href="{{ route('projects.payments.show', [$payment]) }}" 
                                                class="text-indigo-600 hover:text-indigo-900">
                                                    View
                                                </a>
                                                <a href="{{ route('projects.payments.edit', [$payment]) }}" 
                                                class="text-blue-600 hover:text-blue-900">
                                                    Edit
                                                </a>
                                                @if($payment->is_active)
                                                    <form action="{{ route('projects.payments.toggle', [$payment]) }}" method="POST" 
                                                ...
                                                @else
                                                    <form action="{{ route('projects.payments.toggle', [$project, $payment]) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('PATCH')
