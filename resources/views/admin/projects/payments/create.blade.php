    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('projects.payments.index', $project) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                    Back to Payments
                </a>
            </div>
        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="Brief description of this payment">{{ old('description') }}</textarea>
                            ...
                            <div>
                                ...
                                <select name="frequency" id="frequency" required
                                    ...
                                    <option value="one_off" {{ old('frequency') == 'one_off' ? 'selected' : '' }}>One-time Payment</option>
                            ...
                            <div>
                                ...
                                <select name="payment_type" id="payment_type" required
                                    ...
                                    <option value="manual" {{ old('payment_type') == 'manual' ? 'selected' : '' }}>Manual Payment Only</option>
                                    <option value="gateway" {{ old('payment_type') == 'gateway' ? 'selected' : '' }}>Gateway Payment Only</option>
                                    <option value="both" {{ old('payment_type') == 'both' ? 'selected' : '' }}>Both Manual & Gateway</option>
                                </select>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    <input type="checkbox" name="allow_partial_payments" id="allow_partial_payments" value="1"
                                        {{ old('allow_partial_payments') ? 'checked' : '' }}
                                ...
                                <p class="text-sm text-gray-500 ml-6">Enable this payment configuration immediately.</p>
                            </div>

                            <!-- Submit Buttons -->
                            <div class="flex justify-between pt-6 border-t border-gray-200">
                                <a href="{{ route('projects.payments.index', $project) }}" 
