<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('staff.projects.index')" :active="request()->is('projects*')">
                        {{ __('Projects') }}
                    </x-nav-link>
                    
                    <x-nav-link :href="route('staff.staff.index')" :active="request()->is('staff*')">
                        {{ __('Staff') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('staff.projects.index')" :active="request()->is('projects*')">
                {{ __('Projects') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('staff.staff.index')" :active="request()->is('staff*')">
                {{ __('Staff') }}
            </x-responsive-nav-link>
        </div>
