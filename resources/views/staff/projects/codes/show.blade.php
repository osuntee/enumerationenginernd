    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('staff.projects.codes.show', ['project' => $batch->project, 'batch' => $batch, 'print' => 1]) }}" target="_blank" class="bg-gray-800 hover:bg-black text-white font-bold py-2 px-4 rounded text-sm transition-colors flex items-center shadow-lg">
